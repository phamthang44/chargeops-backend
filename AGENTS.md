...
This project is indexed by GitNexus as **chargeops** (4405 symbols, 14474 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/chargeops/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/chargeops/context` | Codebase overview, check index freshness |
| `gitnexus://repo/chargeops/clusters` | All functional areas |
| `gitnexus://repo/chargeops/processes` | All execution flows |
| `gitnexus://repo/chargeops/process/{name}` | Step-by-step execution trace |
